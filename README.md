...
# 1. Validasi Input  cek apakah email memiliki format yang benar (mengandung ’@’) atau password memiliki panjang minimal 6 karakter.
...
class _LoginPageState extends State<LoginPage> {
  ...
  HomePage({required String fullName}) {}
}
```

# 3. Menambahkan kode pada file main.dart
```dart
import 'package:flutter/material.dart';
import 'package:login_register/home_page.dart';
import 'package:login_register/login_page.dart' as login;
...
```
# 4. menambahkan kode pada file home_page.dart 
```dart
...
```
#5. menambahkan kode pada file login_page.dart
```dart
import 'package:flutter/material.dart';
  import 'package:login_register/register_page.dart';
  import 'package:login_register/home_page.dart';
